...
import com.uach.peopleapp.provider.HelperContactos.Tablas;
...
public class ProviderContactos extends ContentProvider {
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case CONTACTOS:
                return Contrato.Contactos.MIME_COLECCION;
            case CONTACTOS_ID:
                return Contrato.Contactos.MIME_RECURSO;
            default:
        ...
        switch (match) {
            case CONTACTOS:
                ...
                c = db.query(Tablas.CONTACTO, projection,
                        ...
                        null, null, sortOrder);
                c.setNotificationUri(resolver, Contrato.Contactos.URI_CONTENIDO);
                break;
            case CONTACTOS_ID:
                // Consultando un solo registro basado en el Id del Uri
                String idContacto = Contrato.Contactos.obtenerIdContacto(uri);
                c = db.query(Tablas.CONTACTO, projection,
                        Contrato.Contactos.ID_CONTACTO + "=" + "\'" + idContacto + "\'"
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        if (_id > 0) {
            ...
            String idContacto = contentValues.getAsString(Contrato.Contactos.ID_CONTACTO);

            return Contrato.Contactos.construirUriContacto(idContacto);
        }
