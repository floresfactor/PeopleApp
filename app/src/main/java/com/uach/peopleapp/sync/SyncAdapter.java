package com.uach.peopleapp.sync;
...
import com.uach.peopleapp.modelo.ProcesadorLocal;
import com.uach.peopleapp.provider.Contrato;
import com.uach.peopleapp.utilidades.UPreferencias;
import com.uach.peopleapp.web.RESTService;
import com.uach.peopleapp.modelo.ProcesadorRemoto;
import com.uach.peopleapp.web.RespuestaApi;
...
public class SyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static final String URL_SYNC_BATCH = "http://192.168.64.2/api/v1/sync";
    ...
    private void tratarGet(JSONObject respuesta) {
        ...
        try {
            ...
            if (ops.size() > 0) {
                ...
                cr.notifyChange(Contrato.Contactos.URI_CONTENIDO, null, false);
            } else {
